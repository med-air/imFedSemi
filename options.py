...
def args_parser():
     ...
     parser.add_argument('--csv_file_train', type=str, default='data/split/train.csv', help='training set csv file')
     parser.add_argument('--csv_file_val', type=str, default='data/split/validation.csv', help='validation set csv file')
     parser.add_argument('--csv_file_test', type=str, default='data/split/test.csv', help='testing set csv file')
     ...
     parser.add_argument('--model_path', type = str, default='models/imfed_semi/model.pth', help='Path for loading the checkpoint')
